...
1. Usa los archivos disponibles en este proyecto de R llamados anole.data.csv y Anolis.tre para reconstruir el estado binario grande (lnSVL >4) vs. pequeño (lnSVL >4) medianta probabilidad marginal y mediante mapeo estocástico.
